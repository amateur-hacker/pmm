  ...
  const cards: Card[] = [
    {
      id: "1",
      title: "Card 1",
      description: "Full description for card 1",
      color: "bg-red-500",
    },
    {
      id: "2",
      ...
      <div className="columns-3 gap-4">
        {items.map((item) => (
          <motion.div
            key={item.id}
            layout
            className="mb-4 bg-linear-to-br from-purple-500 to-pink-500 rounded-lg p-4 text-white font-bold break-inside-avoid"
