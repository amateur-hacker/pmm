...
export function generateMockMembers(count: number = 50) {
  const members = [];
  const names = [
    "Rajesh Kumar", "Priya Sharma", "Amit Singh", "Sunita Devi", "Sanjay Patel",
    "Rita Verma", "Vikash Yadav", "Pooja Mishra", "Rahul Sharma", "Sneha Singh",
    "Anil Gupta", "Kavita Kumari", "Rohit Verma", "Sushma Devi", "Manoj Tiwari",
    "Kiran Sharma", "Rakesh Patel", "Priyanka Singh", "Vivek Sharma", "Anita Devi",
    "Sunil Kumar", "Neha Singh", "Alok Mishra", "Sunita Sharma", "Ravi Verma",
    "Poonam Patel", "Sandeep Kumar", "Rashmi Singh", "Rajesh Tiwari", "Divya Sharma",
    "Amitabh Singh", "Sunita Verma", "Sanjay Sharma", "Rita Patel", "Vikash Singh",
    "Pooja Kumar", "Rahul Verma", "Sneha Patel", "Anil Sharma", "Kavita Singh",
    "Rohit Kumar", "Sushma Verma", "Manoj Sharma", "Kiran Patel", "Rakesh Verma",
    "Priyanka Kumar", "Vivek Patel", "Anita Sharma", "Sunil Verma", "Neha Kumar"
  ];
  ...
  for (let i = 0; i < count; i++) {
    ...
    members.push({
      ...
      email,
      dob: new Date(1970 + Math.floor(Math.random() * 40), Math.floor(Math.random() * 12), Math.floor(Math.random() * 28) + 1).toISOString().split('T')[0],
...
export function generateMockBlogs(count: number = 50) {
  const blogs = [];
  const titles = [
    "Community Development Initiatives", "Education for All Program", "Healthcare Awareness Campaign",
    "Women Empowerment Projects", "Agricultural Support Programs", "Youth Development Activities",
    "Environmental Conservation Efforts", "Cultural Preservation Activities", "Disaster Relief Operations",
    "Infrastructure Development in Villages", "Microfinance for Women", "Digital Literacy Programs",
    "Clean Water Initiatives", "Sanitation Projects", "Skill Development Workshops",
    "Senior Care Services", "Child Welfare Programs", "Sports and Recreation Activities",
    "Festivals and Cultural Events", "Rural Employment Programs", "Health Camps in Villages",
    "Education Scholarship Programs", "Senior Citizens Support", "Rural Road Development",
    "Vocational Training Centers", "Women's Self-Help Groups", "Environmental Clean-up Drives",
    "Tree Plantation Campaigns", "Renewable Energy Projects", "Organic Farming Promotion",
    "Support for Senior Farmers", "Youth Skill Development", "Community Kitchen Initiatives",
    "Rural Healthcare Services", "Literacy Programs", "Women Safety Initiatives",
    "Youth Sports Competitions", "Community Gardens", "Rural Internet Access",
    "Elderly Care Centers", "Community Radio Programs", "Traditional Art Preservation",
    "Cultural Heritage Projects", "Rural Tourism Development", "Support for Artisans",
    "Traditional Medicine Practices", "Community Festivals", "Rural Banking Services",
    "Support for Small Businesses", "Traditional Craft Promotion", "Community Disaster Preparedness"
  ];
  
  const authors = [
    "Dr. Rajesh Sharma", "Ms. Priya Verma", "Mr. Amit Patel", "Mrs. Sunita Devi", "Dr. Sanjay Singh",
    "Ms. Rita Gupta", "Mr. Vikash Yadav", "Mrs. Pooja Mishra", "Dr. Rahul Sharma", "Ms. Sneha Singh",
    "Mr. Anil Kumar", "Mrs. Kavita Kumari", "Dr. Rohit Verma", "Ms. Sushma Devi", "Mr. Manoj Tiwari"
  ];
